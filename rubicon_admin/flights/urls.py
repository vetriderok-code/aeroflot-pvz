...
from flights.api import (
    ...
    telegram_reports,
    telegram_report_video,
    settlement_geocode,
    map_layers,
    operator_dashboard,
)
from flights.api.gsh_tiles import gsh_tile_proxy

urlpatterns = [
    path('', views.map_view, name='map'),           # главная страница с картой
    path('dashboard/', views.dashboard_view, name='dashboard-page'),
    path('operators/', views.operator_dashboard_view, name='operator-dashboard-page'),
    ...
    path('reports/friday/', views.friday_report_view, name='friday-report-page'),
    path('reports/friday/export/', views.friday_report_export_view, name='friday-report-export'),
    ...
    path('api/map-tiles/gsh/<int:z>/<int:x>/<int:y>.png', gsh_tile_proxy, name='map-gsh-tile'),
    ...
    path('api/operators/dashboard/', operator_dashboard.OperatorDashboardAPIView.as_view(), name='operators-dashboard'),
    path('api/operators/position/', operator_dashboard.OperatorPositionAPIView.as_view(), name='operators-position'),
    path(
        'api/operators/location/<uuid:location_id>/comm/',
        operator_dashboard.OperatorLocationCommLinkAPIView.as_view(),
        name='operators-location-comm',
    ),
    path(
        'api/operators/<uuid:profile_id>/history/',
        operator_dashboard.OperatorPositionHistoryAPIView.as_view(),
        name='operators-position-history',
    ),
    ...
    path('api/telegram_reports/map/', telegram_reports.TelegramReportsMapAPIView.as_view(), name='telegram-reports-map'),
    path(
        'api/telegram_reports/<uuid:report_id>/video/',
        telegram_report_video.telegram_report_video_stream,
        name='telegram-report-video',
    ),
